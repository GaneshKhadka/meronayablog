                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                <li role="presentation" class="">
                                    <a href="#profile_only_icon_title" data-toggle="tab" aria-expanded="false">
                                        <i class="material-icons">face</i>UPDATE PROFILE</a>
                                </li>
                                <li role="presentation" class="active">
                                    <a href="#change_password_only_icon_title" data-toggle="tab" aria-expanded="true">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade active in" id="change_password_only_icon_title">
